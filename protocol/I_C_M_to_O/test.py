...
def main():
    ...
    print("**Testing**")
    # load model
    # I_C_M_to_O 是在CWSA加了残差连接
    u_encoder_ = torch.load(config.best_model_path + 'uencoder_best_81.pth.tar') # change to your best weight path
    classifier_ = torch.load(config.best_model_path + 'cls_best_81.pth.tar')
