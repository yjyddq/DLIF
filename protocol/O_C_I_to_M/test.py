...
def main():
    ...
    print("**Testing**")
    # load model
    u_encoder_ = torch.load(config.best_model_path + 'M_add_H/uencoder_best_25.pth.tar') # change to your best weight path
    classifier_ = torch.load(config.best_model_path + 'M_add_H/cls_best_25.pth.tar')
