...
def main():
    ...
    print("**Testing**")
    # load model
    u_encoder_ = torch.load(config.best_model_path + 'uencoder_best.pth.tar') # change to your best weight path
    classifier_ = torch.load(config.best_model_path + 'cls_best.pth.tar')
